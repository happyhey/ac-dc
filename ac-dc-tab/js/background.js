...
if(localStorage.currentDay != currentDay)
{
	jQuery.ajax({
		method:'GET',
		url: 'https://www.happyhey.com/share/ac-dc-tab/share.php?noscript=Yes&r=' + Math.random()
	}).done(function(data){
		if(data!='')
		{
...
document.write('<meta property="og:image" content="https://www.happyhey.com/images/ac-dc-tab/' + id + '.jpg"/>');
document.write('<meta name="twitter:image" content="https://www.happyhey.com/images/ac-dc-tab/' + id + '.jpg"/>');

jQuery('#imgPh').html('<img id="back-img" alt="Do you like it? Share it!" title="Do you like it? Share it! Scroll down for more!" src="https://www.happyhey.com/images/ac-dc-tab/'+id+'.jpg" style="width: 100%; height: auto; position: fixed; top: 0; left: 0; "/>');

jQuery(function () {
	setTimeout(loadFirstPic, 100);
	var id2 = getRandomInt(1, 365);
	var img = new Image();
	img.src = "https://www.happyhey.com/images/ac-dc-tab/" + id2 + ".jpg";
	img.onload = function(){
...
function loadFirstPic() {
	var img = new Image();
	img.src = "https://www.happyhey.com/images/ac-dc-tab/" + id1 + ".jpg";
}
...
jQuery.ajax({
	method:'GET',
	url: 'https://www.happyhey.com/share/ac-dc-tab/getUrl.php?id='+id + '&id1='+id1 + "&r=" + Math.random()
}).done(function(data){
	if(data.indexOf('happyhey.com'))
	{
		...
		var share = new ShareButton({
			...
			title: "Do You Like AC/DC?",
			description: "Get awesome AC/DC HD images in each new Chrome tab!"
		});
		share.open();
	}
})
